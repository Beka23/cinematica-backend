...
bek = User.create(username: "Bek", password: "bek123")
...
movie17 = Movie.create(name: "Pixies", image: "https://m.media-amazon.com/images/M/MV5BMjM5NzIxNDEwMV5BMl5BanBnXkFtZTgwMDgxMjA3NTE@._V1_UY1200_CR135,0,630,1200_AL_.jpg", youtube_url: "https://www.youtube.com/watch?v=wuXn71QRyeE ", description: "Joe Beck (Bill Paxton) has lost the love of his life, Michelle Meyers (Alexa Vega), thanks to a Pixie's Curse and he now needs to figure out how to get his girl back, learn more about the mysterious Pixies and undo a bad deed he did long ago. ", genre_id: animation_family.id , likes: 29, dislikes: 2 , liked: false, disliked: false)  
